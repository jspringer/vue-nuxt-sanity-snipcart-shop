...
export default {
   ...
   */
  head: {
    title: "Candy Shop: E-commerce template using Sanity and Snipcart",
    meta: [
      { charset: "utf-8" },
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        hid: "description",
        name: "description",
        content: "Sanity & Snipcart frontend template for e-commerce using Vue.js and Nuxt"
      }
    ],
    link: [
    ...
    script: [
      ...
      // Snipcart js
      {
        ...
        "data-api-key":
          "MmIwYThiMWEtNzk2My00NjEyLTkyZGUtMGFlMTU0ZGU5YTExNjM2ODU2MjkzNzc1Mzg0Mjky"
      }
    ]
  },
  /*
